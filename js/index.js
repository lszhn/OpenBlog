...
function setColl() {
    $("#collection").css({
        "height": $(".coll_detail_content").height() + 170 + "px"
    });
}
...
function resetColl() {
    $("#collection").css({
        "height": Math.ceil($("#coll_box").children().length / 2) * 120 + 80 + "px"
    });
}
